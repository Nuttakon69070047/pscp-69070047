...
```text
the inputs are two integers on the same line
the output is one integer of the highest row

the constraint is a bunch of math
```
...
```text
Step 1: write code to receive the inputs
Step 2: a bunch of math
...
```text
the final approach uses while true to calculates a bunch of math and gets the highest row
```
...
```text
they did most of the math calculations
```
